 ...
 */
package com.helger.nss.supplementary.tools;
...
/**
 * Utility class to create hash codes of the trust store to verify if it is valid or not.
 *
...
public final class MainCreateTrustStoreHashFiles
{
  ...
  {
    _create (MozillaNSSTrustStore.TRUSTSTORE_CLASSPATH);
  }
}
